...
public class HomePageActivity extends BaseActivity implements HomePageViewer {
    ...
    protected void loadData() {
        ...
        bindView(R.id.test1, v -> {
            BaseActionHelper.with(getActivity()).handleAction("https://www.baidu.com", true);
        });
        bindView(R.id.test2, v -> {
            BaseActionHelper.with(getActivity()).handleAction("https://www.baidu.com", false);
        });
        bindView(R.id.test3, v -> {
