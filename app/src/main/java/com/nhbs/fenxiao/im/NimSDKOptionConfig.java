...
import com.nhbs.fenxiao.module.splash.SplashActivity;
...
public class NimSDKOptionConfig {
    ...
    private static StatusBarNotificationConfig loadStatusBarNotificationConfig() {
        ...
        config.notificationColor = APP.getInstance().getResources().getColor(R.color.color_blue_3a9efb);
        // 通知铃声的uri字符串
        ...
        // save cache，留做切换账号备用
        NimAppCache.setNotificationConfig(config);
        return config;
    }
