...
public class NIMInitManager {
    ...
    private void registerLocaleReceiver(boolean register) {
        if (register) {
            ...
            NimAppCache.getContext().registerReceiver(localeReceiver, filter);
        } else {
            NimAppCache.getContext().unregisterReceiver(localeReceiver);
        }
    }
    ...
    private void updateLocale() {
        Context context = NimAppCache.getContext();
    ...
    private void registerBroadcastMessages(boolean register) {
        NIMClient.getService(
            ...
            public void onEvent(BroadcastMessage broadcastMessage) {
                ToastHelper.showToast(NimAppCache.getContext(), "收到全员广播 ：" +  broadcastMessage.getContent());
            }
        }, register);
    }
