...
public class UserPreferences {
    ...
    private static void saveStatusBarNotificationConfig(
        String key, StatusBarNotificationConfig config) {
    ...
    static SharedPreferences getSharedPreferences() {
        return APP.getInstance().getSharedPreferences("Demo." + NimUIKit.getAccount(), Context.MODE_PRIVATE);
    }
}
